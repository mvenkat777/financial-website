  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <form method="post" action="/index.php?action=certificate-add-process">

        <div class="form-row">
          <div class="form-group col-md-6">
            <label for="isin">ISIN</label>
            <input type="text" class="form-control" id="isin" name="isin" placeholder="Enter your ISIN">
          </div>
          <div class="form-group col-md-6">
            <label for="market">Trading market</label>
            <input type="text" class="form-control" id="market" name="market" placeholder="Enter your trading market">
          </div>
        </div>
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="issuer" name="issuer" placeholder="Enter your Issuer">
          </div>
        </div>
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="issuing_price" name="issuing_price" placeholder="Enter your Issuing price">
          </div>
          <div class="form-group col-md-6">
            <label for="current_price">Current price</label>
            <input type="text" class="form-control" id="current_price" name="current_price" placeholder="Enter your current price">
          </div>
        </div>
        ...
        <div class="form-row">
          <div class="form-group col-md-12" >
              <button type="submit" class="btn btn-primary">Submit certificate details</button>
          </div>
        </div>
